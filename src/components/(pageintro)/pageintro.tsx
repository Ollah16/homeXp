...
export const PageIntro = () => {
    ...
    return (
        <div className="flex justify-center relative z-10 h-[600px] overflow-hidden">
            <Image src={require(`@/assets/homerepair.jpg`)} fill sizes="100vw" quality={100} priority={true} alt="/" className="absolute top-0 bottom-0 z-0 brightness-50 h-full object-cover object-center" />
            <h4
