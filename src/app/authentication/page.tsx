...
const AuthComponent: React.FC = () => {
    ...
    return (
        <div>
            <div className="flex justify-center text-inherit my-20">
                ...
                <div className="w-1/3">
                    ...
                    <form action={handleAuth} className={`formText flex flex-col gap-4 rounded items-center border shadow 'border-black shadow-black/90 p-6`}>
                        ...
                        <input ref={passRef} type="password" name='password' placeholder="Password" className={`placeholder:text-sm placeholder:italic w-full p-2 focus:outline-none border-0 text-black focus:ring-2 focus:ring-gray-500/90 focus:placeholder:absolute focus:placeholder:top-0 'border-[1px] border-black `} />

                        <input ref={emailRef} type="email" name="email" placeholder="Email" className={`placeholder:text-sm placeholder:italic w-full p-2 focus:outline-none border-0 focus:ring-2 text-black focus:ring-gray-500/90 ${!isReg ? 'hidden' : 'inline-block'} 'border-[1px] border-black`} />

                        <button type="submit" className={`text-inherit border bg-inherit 
                            border-black active:bg-black/90 active:text-white hover:bg-black/90 hover:text-white
